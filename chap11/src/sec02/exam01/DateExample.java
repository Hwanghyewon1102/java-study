...
public class DateExample {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy년 MM월 dd일 E EEEE a hh시 mm분 ss초");
		...
		SimpleDateFormat quiz = new SimpleDateFormat("yy년 M월 d일 EEEE H시 m분 s초 S");
		String strNow3 = quiz.format(now); // 원하는 날짜 포맷으로 문자열 반환
