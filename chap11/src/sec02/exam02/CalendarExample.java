...
public class CalendarExample {
	...
	public static void main(String[] args) {
		...
		String strWeek2 = dayOfWeek.getDisplayName(TextStyle.SHORT, Locale.KOREA); // 월, 화, 수...
		System.out.println(strWeek2 + "요일");
		String strWeek00 = dayOfWeek.getDisplayName(TextStyle.FULL, Locale.KOREA); // 월, 화, 수...
		System.out.println(strWeek00);
		...
		if (hour12 == 0)
			hour12 = 12; // 24시간제 기준으로 0시, 12시 일 때 -> 12시
		...
		if (today.isBefore(targetDate)) {
			...
			System.out.println("오늘은 크리스마스 dlgn입니다.");
		} else {
		...
		LocalDateTime deadline = LocalDateTime.of(2025, 8, 4, 18, 0); // 2025년 8월 4일 오후 6시
		...
		long daysBetwen = ChronoUnit.DAYS.between(startDate, endDate);
		System.out.println("전체 일 수 차이: " + daysBetwen + "일");
