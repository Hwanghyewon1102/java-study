...
public class NonBufferVsBufferExample {
	...
	public static void main(String[] args) throws Exception {
		...
		String targerFilePath1 = "C:/Temp/targetFile1.jpg";
		
		
		FileInputStream fis = new FileInputStream(originalFilePath1);
		FileOutputStream fos = new FileOutputStream(targerFilePath1);
		
		// 버퍼 보조 스트림을 적용한 코드
		String originalFilePath2 = NonBufferVsBufferExample.class.getResource("originalFile2.jpg").getPath();
		String targerFilePath2 = "C:/Temp/targetFile1.jpg";
	...
	// 매개 변수 타입은 바이트 기반 스트림으로 그림, 음악, 텍스트 등 모든 종류의 파일을 복사하기 위해
