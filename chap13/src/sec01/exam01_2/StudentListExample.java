...
//		Student student1 = new Student("김철수", 10);
//		Student student2 = new Student("성춘향", 10);
//		
...
//		
		...
		studentList.add(new Student("김철수",30));
		studentList.add(new Student("성춘향",18));
		
		// 객체 검색
		// 사용자 정의 객체를 사용할 경우 indexOf(), contains()가
		// 해당 객체 존재 여부를 판단하는 기준은 equals() // == 비교
