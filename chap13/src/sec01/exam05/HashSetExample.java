...
//			System.out.println("\t" + member);
		...
		// Quiz
		Set<Member> memClass = new HashSet<Member>(memList); // 중복 제거 완료

		
		List<Member> membeList = new ArrayList<Member>(memClass);
		
		System.out.println(membeList);
		for (Member member : membeList) {
			System.out.println(member.getName() + " - " + member.getAge());
		}
	}
