...
public class ScannerExample {
	...
	public static void main(String[] args) {
	   ...
	   Scanner sc = new Scanner(System.in);
		...
		while (true) {
			inputData = sc.nextLine(); // 스캐너에서 읽은 한 줄 전체 (엔터 키 이전까지)
