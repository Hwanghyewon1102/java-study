...
public class Quiz1 {
	public static void main(String[] args) {
		...
		System.out.println("합 :" + calculator.add(scnum1, scnum2) );
		System.out.println("곱 :" + calculator.multiple(scnum1, scnum2) );
		try {
		System.out.println("나누기 :" + calculator.divide(scnum1, scnum2) );
